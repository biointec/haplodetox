...
private:
        ...
        /**
         * Find a variable to eliminate based on the adjacency matrix. Selects
         * the variable (not in varToKeep) with the lowest number of neighbors
         * @param adjMatrix Adjacency matrix
         * @param varToKeep Variables that cannot be eliminated
         * @return Selected variable
         */
        static int findVarToEliminate(const AdjMatrix& adjMatrix, const std::vector<int>& varToKeep);
         ...
         */
        static size_t findElimOrdering(const FactorList& factorList,
                                       const std::vector<int>& varToKeep,
                                       std::vector<int>& elimOrder);
...
public:
        ...
        /**
         * Given a list of factors as input, eliminate all variables with the
         * exception of the target variables. When successful the factorList
         * contains a single factor that has the joint assignment
         * over the target variables
         * @param factorList List of input factors / output target factor
         * @param targetVar Target variable list
         * @param maxFactorSize Maximum number of values in intermediate factor
         * @return True VE completed within maxFactorSize constraints
         */
        static bool solveVE(FactorList& factorList, const std::vector<int>& targetVar,
                            size_t& maxFactorSize);
};
