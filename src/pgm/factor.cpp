...
size_t Assignment::assignmentToIndex(const vector<int>& assignment) const
{
        assert(assignment.size() == card.size());
...
vector<int> Assignment::indexToAssignment(size_t index) const
{
        assert(index < card.size());
