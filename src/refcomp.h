...
public:
        ...
        /**
         * Calculate true node and arc multiplicities when multiple strains
         * are present (i.e. same functionality as getTrueMultiplicity, but stores
         * multiplicity values differently
         */
        void getTrueStrainMultiplicity(NodeMap<std::vector<int>>& nodeMult,
                                       EdgeMap<std::vector<int>>& edgeMult,
                                       size_t strainID);
